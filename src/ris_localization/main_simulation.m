%% main_simulation.m
% =========================================================================
% RIS-Enabled Energy Efficient Integrated Localization and Communication
% for Autonomous Vehicles: Complementary to Visual SLAM
%
% Authors: Eskandari, Savkin, Deghat
% IEEE Trans. Green Commun. Netw., Vol. 10, 2026
%
% This script reproduces ALL simulation results from the paper:
%   - Fig. 3: Dense urban environment setup (Sydney)
%   - Fig. 4: Particle filtering init + estimator convergence
%   - Fig. 5: Multipath impact on localization
%   - Pose graph optimization with virtual loop closure
% =========================================================================
clear; clc; close all;
addpath(genpath(pwd));
...
fprintf('[2/6] Setting up dense urban environment...\n');
